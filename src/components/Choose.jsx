  ...
  return (
    <section className="w-full py-16 px-2 sm:px-8 bg-white">
      <div className="w-full animate-fadein">
        ...
        <p className="text-black text-lg md:text-xl mb-8 text-center">Choosing the right supplier for military, NCC, and ceremonial products is not just about buying an item – it is about trust, reliability, and long-term value. At Trianga Army Store, we go beyond just selling products; we build relationships based on quality and commitment. Here’s why hundreds of customers continue to choose us:</p>
